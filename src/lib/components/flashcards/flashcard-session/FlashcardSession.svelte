...
<div class="flashcard-session">
    ...
    <div class="flashcard-container">
        <NounFlashcard flashcard = {activeFlashcard} on:cardFinished = {(e) => GoToNextCard(e)} />
    </div>
    <div class="session-footer">
        <div class="session-menu">
            <div class="session-info">
                ...
                <div class="actions">
                    <button><span class="material-symbols-outlined">translate</span></button>
            ...
            <div class="progress-bar">
                <div class="progress" style="width:{sessionProgress}"></div>
            </div>
            <div class="session-counters">

                <span id="good-counter"><span class="material-symbols-outlined">check</span>: {goodCounter}</span>
                <span id="skip-counter"><span class="material-symbols-outlined">remove</span>: {skippedCounter}</span>
                <span id="bad-counter"><span class="material-symbols-outlined">close</span>: {badCounter}</span>
            </div>
        </div>
    </div>
</div>
...
<script lang="ts">
    ...
    export const sessionCards: IFlashcard [] =
